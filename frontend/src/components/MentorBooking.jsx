          ...
          <div className="mb-8">
            <div className="flex items-center space-x-4">
              <div className={`flex items-center ${step === 'mentors' ? 'text-blue-600' : 'text-gray-400'}`}>
                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${step === 'mentors' ? 'bg-blue-600 text-white' : 'bg-gray-200'
                  }`}>
                  1
                </div>
              ...
              <div className={`flex items-center ${step === 'slots' ? 'text-blue-600' : 'text-gray-400'}`}>
                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${step === 'slots' ? 'bg-blue-600 text-white' : 'bg-gray-200'
                  }`}>
                  2
                </div>
              ...
              <div className={`flex items-center ${step === 'booking' ? 'text-blue-600' : 'text-gray-400'}`}>
                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${step === 'booking' ? 'bg-blue-600 text-white' : 'bg-gray-200'
                  }`}>
                  3
                </div>
